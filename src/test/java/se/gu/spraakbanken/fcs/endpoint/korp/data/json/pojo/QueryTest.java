...
public class QueryTest {
    ...
    public void queryDeserializeFile() {
        ...
        String queryFilename =
                "src/main/resources/se/gu/spraakbanken/fcs/endpoint/korp/data/json/korp-kwic-1.json";
    ...
    public void queryDeserializeURL() {
        ...
        String queryString =
                "indent=4&command=query&corpus=SUC2&start=0&end=9&defaultcontext=1+sentence&cqp=%22och%22+%5B%5D+%5Bpos=%22NN%22%5D&show=msd,lemma";
        // lang=sv&stats_reduce=word&cqp=[]&word_pic&search_tab=2&corpus=suc2&search=cqp|[word%3D"och"]
        // [] [pos%3D"NN"]
        // command=query
        ...
        try {
            ...
            q4 = mapper.readerFor(Query.class).readValue(korp.openStream());
    ...
    public void missingQueryParameterDeserializeURL() {
        ...
        String wsString = "https://alf.hum.ku.dk/korp/cgi/korp.cgi?";
        String queryString =
                "indent=4&command=query&corpus=SUC2&start=0&end=9&defaultcontext=1+sentence&cq=%22och%22+%5B%5D+%5Bpos=%22NN%22%5D&show=msd,lemma";
        try {
            URL korp = new URL(wsString + queryString);
