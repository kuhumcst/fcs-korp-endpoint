...
/**
 * A result set of an <em>explain</em> operation. A database implementation may use it implement
 * extensions to the SRU protocol, i.e. providing extraResponseData.
 *
 * <p>
